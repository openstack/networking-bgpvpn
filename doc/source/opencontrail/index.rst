...
* Clone devstack:
   ...
   git clone git@github.com:openstack-dev/devstack -b stable/liberty
...
.. code:: bash
 ...
 enable_plugin networking-bgpvpn git://git.openstack.org/openstack/networking-bgpvpn.git stable/liberty
